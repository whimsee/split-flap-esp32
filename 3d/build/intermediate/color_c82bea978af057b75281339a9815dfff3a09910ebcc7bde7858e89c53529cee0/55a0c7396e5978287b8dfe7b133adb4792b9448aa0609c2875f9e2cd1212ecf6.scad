...
use <259db07ac6c3ee8d3d159b4ea7d0da2bcc5f6e58af1d8f4a7541e51b84b77ad0.scad>;
use <568057898756f8e86159f8a2db0d18ae7fa6295edc63737593c81855d3b46972.scad>;
use <6eea83ad851db6503444ec118689f6b77f5bc2306a2852d47fc49ddc961219b8.scad>;
use <2d6798ab09bce8e48758c7832949c396807525656b761a2500eb4bd5027d2ae5.scad>;
use <b3ad730034d6424f7fe8ec85f19b224ff6cbe2c7cff800d50aeda510a560317a.scad>;
use <efc92a7d97f55c1f9add7d0071772447f341dab26808e3ac66b3c3450f92bd9a.scad>;
use <5667c89edc086e1d280d3d424be923c25d2ce01555cd984c17c314e1a50e8484.scad>;
use <83ba7e1ac95b6ec185a0c424f32b71a5066ab6e016e2977c8df17b013a8c046b.scad>;
use <dcf7b3f78bba1fb649c2e770c14bbc13b4d25529d1d70ad9ea1e21d82703b2b9.scad>;
use <f0486a118947d12b8588913fde8c70dda32541eecdf19b9f1da6dda8c842087b.scad>;

include <b4bcf773e5831d03f7268795dbff45f05f51ecf951b4aebbf44fc05c46331807.scad>;
include <e0502a354fbc96373902278e4943000934a67f42f763273f8dc6f9c8e21394c6.scad>;
include <3a8aa1ee2c5f15af7c9a4d3d95d6786cd3b11c8e1af2661494beaac4b8dd79fa.scad>;
...
flap_hole_separation = .76;  // additional spacing between hole edges
...
module spool_struts() {
    for (i=[0:3]) {
        angle = 90*i;
        // color_selector([i < 2 ? 0 : 1, i == 0 || i == 2 ? 0 : 1, 0])
         color_selector(i % 2 == 0 ? assembly_colors[1] : assembly_colors[2])
...
module alignment_bar() {
     color_selector(assembly_colors[0])
...
module split_flap_3d(front_flap_index, include_connector, include_front_panel=true) {
    ...
    module positioned_enclosure() {
        if (render_enclosure == 2) {
             color_selector(assembly_colors[0])
                positioned_front();
             color_selector(assembly_colors[1])
                positioned_left();
             color_selector(assembly_colors[1])
                positioned_right();
             color_selector(assembly_colors[2])
                positioned_top();
             color_selector(assembly_colors[2])
                positioned_bottom();
            ...
            if (include_connector) {
                 color_selector(assembly_colors[3])
...
if (render_3d) {
    ...
    laser_mirror() {
        ...
        module color_selector(c) {
            ...
            if (c == [0.88236, 0.6942, 0.48594] || compare_floats(c, [0.88236, 0.6942, 0.48594]))
                children();
        }
