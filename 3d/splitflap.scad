...
flap_hole_radius = (flap_pin_width + .5) / 2;
flap_hole_separation = .925;  // additional spacing between hole edges
...
magnet_diameter = 6.2;
magnet_hole_clearance = 0;  // interference fit
...
front_window_overhang = 4;
front_window_upper = front_window_upper_base - front_window_overhang;
front_window_lower = sqrt(outer_exclusion_radius*outer_exclusion_radius - front_forward_offset*front_forward_offset) - 13;
...
enclosure_vertical_margin = 3.5; // gap between top/bottom of flaps and top/bottom of enclosure
